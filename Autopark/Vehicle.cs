...
namespace Autopark
{
    public class Vehicle : IComparable<Vehicle>
    {
        ...
        public static readonly Vehicle[] vehicles = new Vehicle[] {
            ...
            new Vehicle(VehicleType.vehicleTypes[0], new ElectricalEngine(50),"Electric Bus E321", "6785 BA-7", 12080, 2019, 20451, 150, Color.Green),
            new Vehicle(VehicleType.vehicleTypes[1], new DieselEngine(1.6, 7.2),"Golf 5", "8682 AX-7", 1200, 2006, 230451, 55, Color.Gray),
            new Vehicle(VehicleType.vehicleTypes[1], new ElectricalEngine(25),"Tesla Model S 70 D", "E001 AA-7", 2200, 2019, 10454, 70, Color.White),
            new Vehicle(VehicleType.vehicleTypes[2], new DieselEngine(3.2, 25),"Hamm HD 12 VV", null, 3000, 2016, 122, 20, Color.Yellow),
            new Vehicle(VehicleType.vehicleTypes[3], new DieselEngine(4.75, 20.1),"МТЗ Беларус-1025.4", "1145 AB-7", 1200, 2020, 109, 135, Color.Red)
        };
